...
//   public static final String URL="http://192.168.0.7:9191/";
    //public static final String URL="http://172.16.1.116:9191/";
   ...
   public static final String URL="http://bicycle.ddns.net:9191/";
    ...
    public static final String URL_STATISTICS = ApiRestConnection.URL+"statistics/";
    ...
    public static StatisticsApiService getServiceStatistics(Context context){
        return ClientRetrofit.getClientWithInterceptor(URL_STATISTICS,context).create(StatisticsApiService.class);
    }
