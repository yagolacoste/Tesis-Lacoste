...
CREATE TABLE `friends` (
  ...
  CONSTRAINT `fk_appuser_has_appuser_appuser1` FOREIGN KEY (`appuser_id`) REFERENCES `appuser` (`appuser`),
  CONSTRAINT `fk_appuser_has_appuser_appuser2` FOREIGN KEY (`appuser_id_friends`) REFERENCES `appuser` (`appuser`)
